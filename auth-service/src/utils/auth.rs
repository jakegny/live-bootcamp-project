...
use crate::{domain::email::Email, services::app_state::BannedTokenStoreType};
...
pub async fn validate_token(
    ...
    if store.is_token_banned(token).await {
...
mod tests {
    ...
    async fn test_validate_token_with_valid_token() {
        let banned_token_store: HashSetBannedTokenStore = HashSetBannedTokenStore::default();
